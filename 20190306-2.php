...
$query_Recordset1 = "SELECT * FROM persons";
...
<body>
  ...
  <tr>
    ...
    <td data-th="品名"><?php echo $row_Recordset1['FirstName']; ?></td>
    <td data-th="價格"><?php echo $row_Recordset1['LastName']; ?></td>
    <td data-th="備註"><?php echo $row_Recordset1['Age']; ?></td>
  </tr>
